                ...
                <div class="misc-wrapper"><a class="brand-logo" href="{{ route('dashboard.view') }}">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">Oops! 😖 You are Unauthorized to view this module!</p>

                            <a class="btn btn-primary mb-2 btn-sm-block" href="{{ route('login') }}">Back to home</a>

                            <img class="img-fluid" src="{{ asset('admin/app-assets/images/pages/not-authorized.svg') }}" alt="Error page" />
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
