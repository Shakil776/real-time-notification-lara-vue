...
<head>
    ...
    <title>Login | Sukhtara International Ltd.</title>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <a class="brand-logo" href="javascript:void(0);">
                            <img class="img-fluid" src="{{ asset('admin/assets/img/logo.png') }}" alt="Image" width="25px"/>
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Welcome to Sukhtara HR Management! </h2>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" type="text" name="email" placeholder="john@example.com" aria-describedby="email" autofocus="" tabindex="1" value="{{ old('email') }}" />
                                         @if ($errors->has('email'))
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="password">Password</label><a href="{{ route('forgetPassword') }}"><small>Forgot Password?</small></a>
                                        </div>
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge {{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" type="password" name="password" placeholder="******" aria-describedby="password" tabindex="2" value="" />
